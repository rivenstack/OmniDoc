...
canonical role label; `ux_researcher` is the registered Cursor
identifier; in opencode the agent and executable command are
`/ux-researcher` (alias `/ux_researcher`).
